...
#----------------------ADMIN COMMAND------------------------------#
		    ...
		    ki2.updateDisplayPicture(backup2.pictureStatus)
              ...
              if msg.from_ in admin:
                ...
                cl.sendText(msg.to, "% วินาที" % (elapsed_time))
...
#-----------------------------------------------------------
                ...
                elapsed_time = time.time() - start
                ki.sendText(msg.to, "% วินาที" % (elapsed_time))
                elapsed_time = time.time() - start
                ki2.sendText(msg.to, "% วินาที" % (elapsed_time))
                elapsed_time = time.time() - start
                ki3.sendText(msg.to, "% วินาที" % (elapsed_time))
                elapsed_time = time.time() - start
                ki4.sendText(msg.to, "% วินาที" % (elapsed_time))
		elapsed_time = time.time() - start
                ki5.sendText(msg.to, "% วินาที" % (elapsed_time))
