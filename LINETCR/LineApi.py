...
class LINE:
  ...
  def login(self, mail=None, passwd=None, cert=None, token=None, qr=False, callback=None):
    ...
    self._headers = {'X-Line-Application': 'IOSIPAD\t8.3.1\tiPhone OS\t11.12.17', 'X-Line-Access': self.authToken, 'User-Agent': 'Line/8.3.1'}
    self.cert = self.Talk.cert
    self._headers = {
              'X-Line-Application': 'IOSIPAD\t8.3.1\tiPhone OS\t11.12.17', 
              'X-Line-Access': self.authToken, 
              'User-Agent': 'Line/8.3.1'
   }
