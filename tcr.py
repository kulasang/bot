...
cl = LINETCR.LINE()
cl.login(token="EoexODPDphSdTYwyW8g6.0P3FlAwpvyaZKXTQhGnEXG.0iT3wrk1SlAkkxVdpJHSEmcC/dAT6SqOwCNdmpaNhxE=")
cl.loginResult()
...
def bot(op):
    try:
        ...
        if op.type == 13:
            ...
            cl.sendText(op.param1, "ขณะนี้มีการเชิญ...\nคนแปลกหน้าเข้าร่วมกลุ่ม")
        if op.type == 13:
                if op.param3 in mid:
                ...
                if mid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("เนื่องจากไม่มีกฎกติกาหรือกลุ่ม, \n["+op.param1+"]\nของ\n["+op.param2+"]\nฉันไม่สามารถเตะได้\nเพิ่มลงในบัญชีดำ")
                ...
                if Amid in op.param3:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print ("clientเนื่องจากไม่มีกฎกติกาหรือกลุ่ม, \n["+op.param1+"]\nของ\n["+op.param2+"]\nฉันไม่สามารถเตะได้\nเพิ่มลงในบัญชีดำ")
                        if op.param2 in wait["blacklist"]:
                            pass
                        if op.param2 in wait["whitelist"]:
                            pass
...
#--------------------------------------------------------------------------------------------------------------ตัดออกไปก่อนที่ส่งข้อมูลเข้ากลุ่ม
...
#                return
#--------------------------------------------------------------------------------------------------------------
            elif msg.text in ["Key","บอท","บอด","Bot","bot"]:
                if wait["lang"] == "JP":
                ...
                kk.sendMessage(msg)
            elif msg.text in ["æ„›ã®ãƒ—ãƒ¬ã‚¼ãƒ³ãƒˆ","cGift"]:
                msg.contentType = 9
                ...
                kk.sendMessage(msg)
                kc.sendMessage(msg)
            elif msg.text in ["ccancel","cCancel"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    if X.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            cl.sendText(msg.to,"ไม่มีสมาชิกที่ค้างเชิญแล้วค่ะ")
                        else:
            ...
            elif msg.text in ["Cv cancel","Bot cancelcv"]:
                if msg.toType == 2:
                    ...
                    if G.invitee is not None:
                        ...
                        if wait["lang"] == "JP":
                            k3.sendText(msg.to,"ไม่มีสมาชิกที่ค้างเชิญแล้วค่ะ")
                        else:
                            k3.sendText(msg.to,"Sorry, nobody absent")
                else:
                    if wait["lang"] == "JP":
                        k3.sendText(msg.to,"ไม่สามารถใช้นอกกลุ่มได้")
                    else:
                        k3.sendText(msg.to,"Not for use less than group")
            #elif "gurl" == msg.text:
                #print cl.getGroup(msg.to)
                ##cl.sendMessage(msg)
            elif msg.text in ["Ourlcv","cLink on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    cl.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv1 ourl","Cv1 clink on"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                    ki.updateGroup(X)
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Cv2 ourl","Cv2 clink on"]:
                if msg.toType == 2:
            ...
            elif msg.text in ["Cv3 ourl","Cv3 clink on"]:
                if msg.toType == 2:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                msg.contentMetadata = {
                                     ...
                                     "STKVER": "100" }
                ki.sendMessage(msg)
            elif msg.text in ["ยินดีต้อนรับ","Welcome"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "247",
                ...
                cl.sendMessage(msg)
            elif msg.text in ["é€£çµ¡å…ˆ:ã‚ªãƒ³","K on","CContact on","é¡¯ç¤ºï¼šé–‹"]:
                ...
                if wait["contact"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["è‡ªå‹•å‚åŠ :ã‚ªãƒ³","Join oncv","Auto join:oncv","è‡ªå‹•åƒåŠ ï¼šé–‹"]:
                if wait["autoJoin"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["è‡ªå‹•å‚åŠ :ã‚ªãƒ•","Join offcv","Auto join:offcv","è‡ªå‹•åƒåŠ ï¼šé—œ"]:
            ...
            elif msg.text in ["å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ³","Leave oncv","Auto leave:oncv","å¼·åˆ¶è‡ªå‹•é€€å‡ºï¼šé–‹"]:
                if wait["leaveRoom"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
            ...
            elif msg.text in ["å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ•","Leave offcv","Auto leave:offcv","å¼·åˆ¶è‡ªå‹•é€€å‡ºï¼šé—œ"]:
                if wait["leaveRoom"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"already")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ³","Share oncv","Share oncv"]:
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"already on")
                    else:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å¼€ã€‚")
            elif msg.text in ["å…±æœ‰:ã‚ªãƒ•","Share offcv","Share offcv"]:
...
#                else:md+=" Auto Join Group by Ticket : off\n"
            ...
            elif msg.text in ["cCancelall"]:
                gid = cl.getGroupIdsInvited()
                for i in gid:
                    cl.rejectGroupInvitation(i)
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"คุณได้ยกเลิกคำเชิญทั้งหมดแล้ว")
                else:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,str(i) + "åˆ é™¤äº†äº‹çš„ç›¸å†Œã€‚")
            elif msg.text in ["è‡ªå‹•è¿½åŠ :ã‚ªãƒ³","Add oncv","Auto add:oncv","è‡ªå‹•è¿½åŠ ï¼šé–‹"]:
                if wait["autoAdd"] == True:
                    if wait["lang"] == "JP":
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å¼€ã€‚")
            elif msg.text in ["è‡ªå‹•è¿½åŠ :ã‚ªãƒ•","Add offcv","Auto add:offcv","è‡ªå‹•è¿½åŠ ï¼šé—œ"]:
                if wait["autoAdd"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å…³æ–­ã€‚")
            elif "cMessage change: " in msg.text:
                wait["cmessage"] = msg.text.replace("cMessage change: ","")
                cl.sendText(msg.to,"cmessage changed")
            elif "cMessage add: " in msg.text:
                wait["cmessage"] = msg.text.replace("cMessage add: ","")
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"cmessage changed")
                else:
                ...
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,"cmessage change to\n\n" + wait["cmessage"])
                else:
                    cl.sendText(msg.to,"The automatic appending information is set as followsã€‚\n\n" + wait["message"])
            elif "cComment:" in msg.text:
                c = msg.text.replace("cComment:","")
                if c in [""," ","\n",None]:
                    cl.sendText(msg.to,"cmessage changed")
                else:
                    wait["ccomment"] = c
                    cl.sendText(msg.to,"cchanged\n\n" + c)
            elif "cAdd comment:" in msg.text:
                c = msg.text.replace("cAdd comment:","")
                if c in [""," ","\n",None]:
                ...
                if wait["ccommentOn"] == False:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"è¦äº†å…³æ–­ã€‚")
            elif msg.text in ["cComment","ç•™è¨€ç¢ºèª"]:
                cl.sendText(msg.to,"message changed to\n\n" + str(wait["comment"]))
            elif msg.text in ["cGurl"]:
                if msg.toType == 2:
                    x = cl.getGroup(msg.to)
            ...
            elif msg.text in ["cComment bl confirm"]:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ...
                    for jj in matched_list:
                        try:
                            ...
                            pass
            elif "cCleanseccv" in msg.text:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("cCleanseccv","")
            ...
            elif "cNk " in msg.text:
                  if msg.from_ in admin:
                       nk0 = msg.text.replace("cNk ","")
                       nk1 = nk0.lstrip()
                       nk2 = nk1.replace("@","")
                       nk3 = nk2.rstrip()
                       _name = nk3
                       ...
                       if targets == []:
                           ...
                           for target in targets:
                                try:
                                    ...
                                    kk.sendText(msg.to,"Fuck You")
            elif "cBlacklist @ " in msg.text:
                _name = msg.text.replace("cBlacklist @ ","")
            ...
            elif "cBancv @" in msg.text:
                if msg.toType == 2:
                    print "[Ban]ok"
                    _name = msg.text.replace("cBancv @","")
            ...
            elif "cUnbancv @" in msg.text:
                if msg.toType == 2:
                    print "[Unbancv]ok"
                    _name = msg.text.replace("cUnbancv @","")
                    _nametarget = _name.rstrip('  ')
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
                    gs = kc.getGroup(msg.to)
...
#------------------------------------------------------------------
                ...
                print "[Command]dp executed"			
#------------------------------------------------------------------
            elif msg.text in ["Bancv"]:
                wait["wblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
                kc.sendText(msg.to,"send contact")
            elif msg.text in ["Unbancv"]:
                wait["dblacklist"] = True
                cl.sendText(msg.to,"send contact")
                ki.sendText(msg.to,"send contact")
                kk.sendText(msg.to,"send contact")
                kc.sendText(msg.to,"send contact")
            elif msg.text in ["Banlistcv"]:
                if wait["blacklist"] == {}:
                ...
                if msg.toType == 2:
                    ...
                    for tag in wait["blacklist"]:
                        matched_list+=filter(lambda str: str == tag, gMembMids)
                    if matched_list == []:
                        cl.sendText(msg.to,"ไม่มีสมาชิกติดบัญชีดำ")
                        ki.sendText(msg.to,"ไม่มีสมาชิกติดบัญชีดำ")
                        kk.sendText(msg.to,"ไม่มีสมาชิกติดบัญชีดำ")
                        kc.sendText(msg.to,"ไม่มีสมาชิกติดบัญชีดำ")
                        return
                    for jj in matched_list:
            ...
            elif "randomcv:" in msg.text:
                if msg.toType == 2:
                    strnum = msg.text.replace("randomcv:","")
            ...
            elif "calbumâ†’" in msg.text:
                try:
                    albumtags = msg.text.replace("calbumâ†’","")
                    gid = albumtags[:6]
                    ...
                    cl.sendText(msg.to,"Error")
            elif "cfakecâ†’" in msg.text:
                try:
                    source_str = 'abcdefghijklmnopqrstuvwxyz1234567890@:;./_][!&%$#)(=~^|'
                    name = "".join([random.choice(source_str) for x in xrange(10)])
                    anu = msg.text.replace("cfakecâ†’","")
...
#---------------------
        ...
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "ออกกลุ่มอีกแล้ว\nโชคดีนะคะ บะบาย 😊")
